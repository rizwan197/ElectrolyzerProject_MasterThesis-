...
hold on
plot(nH2(1,:),specEl(1,:),'b')
hold on
plot(nH2(3,:),specEl(3,:),'k')
hold on
plot(nH2(5,:),specEl(5,:),'r')
hold on
plot(nH2(2,:),specEl(2,:),'b--')
hold on
plot(nH2(4,:),specEl(4,:),'k--')
hold on
plot(nH2(6,:),specEl(6,:),'r--')
