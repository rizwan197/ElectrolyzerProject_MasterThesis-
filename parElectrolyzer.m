...
par.Const = struct('ze',2,'FC',96485,'R',8.314,'Cp',4186,'CpLye',3100.6,...
    'Mwt',18,'MwtH2',2.01588,'Tref',25,'rho',1000,'rhoLye',1258.2,'Vc',2.0681,'Vh',1.9944);
%Cp=specific heat of water, [J/kgK];Mwt=mol. wt of H2O, rho=density of
...
par.Storage = struct('VstoH2',965,'VstoO2',482.5,'PoutH2',19,'PoutO2',19,...
    'TstoH2',25+273.15,'TstoO2',25+273.15,'Rg',8.314e-2,'VdispH2',0.5,'VdispO2',0.5);
%VstoH2 and VstoO2 are in kilolitres
...
par.kvalveH2 = 0.014723;    %[kmol*s^-1*bar^-0.5] valve constant for the outlet valve of hydrogen storage tank,
%calculated for 25 bar storage pressure at SS   
par.kvalveO2 = 0.007362;     %[kmol*s^-1*bar^-0.5] valve constant for the outlet valve of oxygen storage tank,
%calculated for 25 bar storage pressure at SS    
...
%     par.U(i).f2 = 0.98;
    ...
    par.TherMo(i).CtS = 625/27;         %Suggested by Vidar, specific thermal capacity of electrolyzer i.e. Ct/P, [kJ/kWatts*degC] 
    par.TherMo(i).Ct = 625/27*2134;     %Cts*Pnom [kJ/degC], Assuming Pnom = 2134 kWatts                   
