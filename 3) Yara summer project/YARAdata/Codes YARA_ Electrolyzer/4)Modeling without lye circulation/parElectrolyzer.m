...
par.Const = struct('ze',2,'FC',96485,'R',8.314);
par.Comp = struct('alpha',0.63,'k',1.62,'Tel',25+273,'Pel',3);
par.Storage = struct('VstoH2',5,'VstoO2',5,'PoutH2',19,'PoutO2',19,'TstoH2',25+273,'TstoO2',25+273,'Rg',8.314e-2,'VdispH2',.4,'VdispO2',.4);
...
par.TherMo(i).Ct = 625e2;       %625e3                         %thermal capacity of electrolyzer, J C^-1
