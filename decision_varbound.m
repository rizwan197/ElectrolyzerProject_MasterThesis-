...
% lbq_lye_k = 6.63e3*ones(N,1);      %fixed lye flowrate for OSHex
% ubq_lye_k = 6.63e3*ones(N,1);

% lbq_lye_k = 7.18e3*ones(N,1);      %fixed lye flowrate for NewHex
% ubq_lye_k = 7.18e3*ones(N,1);

% lbq_lye_k = 6.53e3*ones(N,1);      %fixed lye flowrate for DegHex
% ubq_lye_k = 6.53e3*ones(N,1);
