...
fig1 = figure('NumberTitle', 'off','Name', 'State 1 Flowsheet 1');
hold on
...
legend('F_1HX_{BoL}q_{lye,var}','F_1HX_{OS}q_{lye,var}','F_1HX_{EoL}q_{lye,var}','F_1HX_{BoL}q_{lye,fix}','F_1HX_{OS}q_{lye,fix}','F_1HX_{EoL}q_{lye,fix}')
...
set(0, 'DefaultAxesFontSize', 12,  'DefaultLineLineWidth', 1.5)
fig2 = figure('NumberTitle', 'off', 'Name', 'State 1 Flowsheet 2');
hold on
...
legend('F_2HX_{BoL}q_{lye,var}','F_2HX_{EoL}q_{lye,var}','F_2HX_{BoL}q_{lye,fix}','F_2HX_{OS}q_{lye,fix}','F_2HX_{EoL}q_{lye,fix}')
xlabel('Input Power, [MW]')
ylabel('% Loss in production w.r.t F_2HX_{OS}q_{lye,var}')
grid on
xlim([1,7])
